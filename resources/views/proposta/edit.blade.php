                    ...
                    <form method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <select name="processo[status]"
                                            ...
                                            <option value="1" @if ($processo->status == 1) selected @endif>Em
                                                andamento
                                            </option>
                                            <option value="2" @if ($processo->status == 2) selected @endif>
                                                Aguardando
                                                aprovação</option>
                                            <option value="3" @if ($processo->status == 3) selected @endif>
                                                Declinou
                                            </option>
                                            <option value="4" @if ($processo->status == 4) selected @endif>
                                                Registrado
                                            </option>
                                            <option value="5" @if ($processo->status == 5) selected @endif>
                                                Cancelado
                                            </option>
                                            <option value="6" @if ($processo->status == 6) selected @endif> Em
                                                análise
                                                de Crédito
                                            </option>
                                            <option value="7" @if ($processo->status == 7) selected @endif> Em
                                                Registro
                                            </option>
                                            <option value="8" @if ($processo->status == 8) selected @endif>
                                                Crédito
                                                Aprovado
                                            </option>
                                        </select>
                        ...
                        <div class="card card-navy">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="comprador[estado_civil]" onchange="setEstadoCivil()"
                                            ...
                                            <option value="2" {{ $comprador->estado_civil == 2 ? 'selected' : '' }}>
                                                Casado(a)</option>
                                            <option value="3" {{ $comprador->estado_civil == 3 ? 'selected' : '' }}>
                                                União
                                                estável</option>
                                            ...
                                            <option value="5" {{ $comprador->estado_civil == 5 ? 'selected' : '' }}>
                                                Viúvo(a)</option>
                                                <option value="6" {{ $comprador->estado_civil == 6  ? 'selected' : '' }}>
                                                Separado(a)</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="comprador[sexo]"
                                            class="custom-select form-control form-control-border">
                                            <option value="">Selecione</option>
                                            <option value="1" @if ($comprador->sexo == 1) selected @endif>
                                                Masculino
                                            </option>
                                            <option value="2" @if ($comprador->sexo == 2) selected @endif>
                                                Feminino
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-4">
                                        ...
                                        <select class="custom-select form-control form-control-border"
                                            ...
                                            <option value="">Selecione</option>
                                            <option {{ $comprador->tipo_documento == 'RG' ? 'selected' : '' }}
                                                value="RG">
                                                RG</option>
                                            <option {{ $comprador->tipo_documento == 'CNH' ? 'selected' : '' }}
                                                value="CNH">
                                                CNH</option>
                                            <option
                                                {{ $comprador->tipo_documento == 'Carteira Funcional' ? 'selected' : '' }}
                                                value="Carteira Funcional">
                                                Carteira Funcional</option>
                                            <option
                                                {{ $comprador->tipo_documento == 'Identidade Militar' ? 'selected' : '' }}
                                                value="Identidade Militar">
                                                Identidade Militar</option>
                                            <option {{ $comprador->tipo_documento == 'OAB' ? 'selected' : '' }}
                                                value="OAB">
                                                OAB</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input value="{{ $comprador->profissao }}" type="text"
                                            name="comprador[profissao]" placeholder="Profissão"
                                            class="form-control form-control-border">
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3 dados-casamento-1"
                                    @if ($comprador->estado_civil != 2 && $comprador->estado_civil != 3) style="display:none;" @endif>
                                    <div class="col-6">
                                        <label>Regime de bens</label>
                                        <select name="comprador[regime_bens]"
                                            class="custom-select form-control form-control-border">
                                            <option value="">Selecione</option>
                                            <option value="1" @if ($comprador->regime_bens == 1) selected @endif>
                                                Comunhão
                                                Parcial de Bens</option>
                                            <option value="2" @if ($comprador->regime_bens == 2) selected @endif>
                                                Comunhão
                                                Universal de Bens</option>
                                            <option value="3" @if ($comprador->regime_bens == 3) selected @endif>
                                                Separação
                                                Total
                                                de Bens</option>
                                            <option value="4" @if ($comprador->regime_bens == 4) selected @endif>
                                                Separação
                                                Obrigatória
                                                de Bens</option>
                                ...
                                <div class="row mt-3">
                                    <div class="col-3">
                                        ...
                                        <input type="text" name="endereco_comprador[cep]"
                                            ...
                                            class="form-control form-control-border cep" onkeyup="pesquisacep(1)"
                                            id="cep1">
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <select name="profissao_comprador[contratacao]"
                                            class="custom-select form-control form-control-border">
                                            <option value="1" @if ($profissaoComprador->contratacao == 1) selected @endif>
                                                Assalariado</option>
                                            <option value="2" @if ($profissaoComprador->contratacao == 2) selected @endif>
                                                Aposentado
                                            </option>
                                            <option value="3" @if ($profissaoComprador->contratacao == 3) selected @endif>
                                                Sócio
                                                Proprietário</option>
                                            <option value="4" @if ($profissaoComprador->contratacao == 4) selected @endif>
                                                Autônomo
                                            </option>
                                            <option value="5" @if ($profissaoComprador->contratacao == 5) selected @endif>
                        ...
                        {{-- conjuge 1 --}}
                        @if ($conjugeComprador)
                            <div class="card card-navy conjuge1"
                                @if ($comprador->estado_civil != 2 && $comprador->estado_civil != 3) style="display:none;" @endif>
                                <div class="card-header">
                                    <h3 class="card-title">
                                ...
                                <div class="card-body">
                                    <div class="row mt-2">
                                        <div class="col-4">
                                            <label>CPF </label>
                                            <input type="text" value="{{ $conjugeComprador->cpf }}"
                                                name="conjuge[cpf]" placeholder="CPF"
                                                class="form-control form-control-border cpf">
                                        </div>
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                            <input type="date" value="{{ $conjugeComprador->data_nascimento }}"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label>Nome</label>
                                            <input type="text" name="conjuge[nome]"
                                                value="{{ $conjugeComprador->nome }}" placeholder="Nome"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-6">
                                            <label>Sexo</label>
                                            <select name="conjuge[sexo]"
                                                class="custom-select form-control form-control-border">
                                                <option value="1" @if ($conjugeComprador->sexo == 1) selected @endif>
                                                    Masculino
                                                </option>
                                                <option value="2" @if ($conjugeComprador->sexo == 2) selected @endif>
                                                    Feminino
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <select name="conjuge[pais]" placeholder="Nacionalidade"
                                                ...
                                                @foreach ($nacionalidades as $n)
                                                    <option value="{{ $n }}"
                                                        {{ $conjugeComprador->pais == $n ? 'selected' : '' }}>
                                                        {{ $n }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <select class="custom-select form-control form-control-border"
                                                ...
                                                <option value="">Selecione</option>
                                                <option {{ $conjugeComprador->tipo_documento == 'RG' ? 'selected' : '' }}
                                                    value="RG">
                                                    RG</option>
                                                <option {{ $conjugeComprador->tipo_documento == 'CNH' ? 'selected' : '' }}
                                                    value="CNH">
                                                    CNH</option>
                                                <option
                                                    {{ $conjugeComprador->tipo_documento == 'Carteira Funcional' ? 'selected' : '' }}
                                                    value="Carteira Funcional">
                                                    Carteira Funcional</option>
                                                <option
                                                    {{ $conjugeComprador->tipo_documento == 'Identidade Militar' ? 'selected' : '' }}
                                                    value="Identidade Militar">
                                                    Identidade Militar</option>
                                                <option {{ $conjugeComprador->tipo_documento == 'OAB' ? 'selected' : '' }}
                                                    value="OAB">
                                                    OAB</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="conjuge[orgao_emissor]"
                                                value="{{ $conjugeComprador->orgao_emissor }}"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Telefone</label>
                                            <input type="text" name="conjuge[telefone]"
                                                value="{{ $conjugeComprador->telefone }}" placeholder="Telefone"
                                                class="form-control form-control-border telefone">
                                        </div>

                                        <div class="col-4">
                                            <label>Celular</label>
                                            <input type="text" name="conjuge[celular]"
                                                value="{{ $conjugeComprador->celular }}" placeholder="Celular"
                                                class="form-control form-control-border celular">
                                        </div>

                                        <div class="col-4">
                                            <label>E-mail</label>
                                            <input type="text" name="conjuge[email]"
                                                value="{{ $conjugeComprador->email }}" placeholder="E-mail"
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="conjuge[nome_empresa]"
                                                value="{{ $conjugeComprador->nome_empresa }}"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <select name="conjuge[contratacao]"
                                                class="custom-select form-control form-control-border">
                                                <option value="1"
                                                    {{ $conjugeComprador->contratacao == 1 ? 'selected' : '' }}>
                                                    Assalariado
                                                </option>
                                                <option value="2"
                                                    {{ $conjugeComprador->contratacao == 2 ? 'selected' : '' }}>
                                                    Aposentado</option>
                                                <option value="3"
                                                    {{ $conjugeComprador->contratacao == 3 ? 'selected' : '' }}>Sócio
                                                    Proprietário</option>
                                                <option value="4"
                                                    {{ $conjugeComprador->contratacao == 4 ? 'selected' : '' }}>
                                                    Autônomo
                                                </option>
                                                <option value="5"
                                                    {{ $conjugeComprador->contratacao == 5 ? 'selected' : '' }}>
                                                    Profissional liberal</option>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="date" name="conjuge[admissao]"
                                                value="{{ $conjugeComprador->admissao }}"
                                                class="form-control form-control-border">
                                        </div>
                                        {{-- <div class="col-4">
                                <label>Cargo</label>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="conjuge[outra_renda_mensal]"
                                                value="{{ $conjugeComprador->outra_renda_mensal }}"
                                                placeholder="Outra renda mensal"
                                                class="form-control form-control-border decimal">
                                        </div>
                                        <div class="col-4">
                            ...
                            <div class="card card-navy conjuge1" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        {{-- <div class="col-4">
                                            <label>Nome da mãe</label>
                                            <input type="text" value="{{ old('conjuge.nome_mae') }}"
                                                name="conjuge[nome_mae]" placeholder="Nome da mãe"
                                                class="form-control form-control-border">
                                        </div> --}}
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <select class="custom-select form-control form-control-border"
                                                ...
                                                <option value="CNH">
                                                    CNH</option>
                                                <option value="Carteira Funcional">
                                                    Carteira Funcional</option>
                                                <option value="Identidade Militar">
                                                    Identidade Militar</option>
                                                <option value="OAB">
                                                    OAB</option>
                                            </select>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Telefone</label>
                                            <input type="text" value="{{ old('conjuge.telefone') }}"
                                                name="conjuge[telefone]" placeholder=""
                                                class="form-control form-control-border telefone">
                                        </div>

                                        <div class="col-4">
                                            <label>Celular</label>
                                            <input type="text" value="{{ old('conjuge.celular') }}"
                                                name="conjuge[celular]" placeholder=""
                                                class="form-control form-control-border celular">
                                        </div>

                                        <div class="col-4">
                                            <label>E-mail</label>
                                            <input type="text" value="{{ old('conjuge.email') }}"
                                                name="conjuge[email]" placeholder=""
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <select name="conjuge[contratacao]"
                                                ...
                                                <option value="">Selecione</option>
                                                <option value="1"
                                                    {{ old('conjuge.contratacao') == 1 ? 'selected' : '' }}>
                                                    Assalariado</option>
                                                <option value="2"
                                                    {{ old('conjuge.contratacao') == 2 ? 'selected' : '' }}>
                                                    Aposentado</option>
                                                <option value="3"
                                                    {{ old('conjuge.contratacao') == 3 ? 'selected' : '' }}>
                                                    Sócio Proprietário</option>
                                                <option value="4"
                                                    {{ old('conjuge.contratacao') == 4 ? 'selected' : '' }}>
                                                    Autônomo</option>
                                                <option value="5"
                                                    {{ old('conjuge.contratacao') == 5 ? 'selected' : '' }}>
                                                    Profissional liberal</option>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                            <label>Data admissão</label>
                                            <input type="date" value="{{ old('conjuge.admissao') }}"
                                                name="conjuge[admissao]" class="form-control form-control-border">
                                        </div>
                                        {{-- <div class="col-4">
                                <label>Cargo</label>
                        ...
                        @if ($comprador2)
                            ...
                            <div class="card card-navy ">
                                <div class="card-header cp" data-toggle="collapse" href="#comp2">
                                    <h3 class="card-title">
                                        Dados Pessoais Comprador 2
                                    </h3>

                                </div>
                                <div class="card-body collapse show" id="comp2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <select name="comprador2[estado_civil]" onchange="setEstadoCivil2()"
                                                ...
                                                <option value="">Selecione</option>
                                                <option value="1"
                                                    {{ $comprador2->estado_civil == 1 ? 'selected' : '' }}>
                                                    Solteiro(a)</option>
                                                <option value="2"
                                                    {{ $comprador2->estado_civil == 2 ? 'selected' : '' }}>
                                                    Casado(a)</option>
                                                <option value="3"
                                                    {{ $comprador2->estado_civil == 3 ? 'selected' : '' }}>
                                                    União
                                                    estável</option>
                                                <option value="4"
                                                    {{ $comprador2->estado_civil == 4 ? 'selected' : '' }}>
                                                    Divorciado(a)</option>
                                                <option value="5"
                                                    {{ $comprador2->estado_civil == 5 ? 'selected' : '' }}>
                                                    Viúvo(a)</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            <label>Nome</label>
                                            <input type="text" value="{{ $comprador2->nome }}"
                                                name="comprador2[nome]" placeholder="Nome"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-6">
                                            <label>Sexo</label>
                                            <select name="comprador2[sexo]"
                                                class="custom-select form-control form-control-border">
                                                <option value="">Selecione</option>
                                                <option value="1" @if ($comprador2->sexo == 1) selected @endif>
                                                    Masculino</option>
                                                <option value="2" @if ($comprador2->sexo == 2) selected @endif>
                                                    Feminino</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <select class="custom-select form-control form-control-border"
                                                ...
                                                <option value="">Selecione</option>
                                                <option {{ $comprador2->tipo_documento == 'RG' ? 'selected' : '' }}
                                                    value="RG">
                                                    RG</option>
                                                <option {{ $comprador2->tipo_documento == 'CNH' ? 'selected' : '' }}
                                                    value="CNH">
                                                    CNH</option>
                                                <option
                                                    {{ $comprador2->tipo_documento == 'Carteira Funcional' ? 'selected' : '' }}
                                                    value="Carteira Funcional">
                                                    Carteira Funcional</option>
                                                <option
                                                    {{ $comprador2->tipo_documento == 'Identidade Militar' ? 'selected' : '' }}
                                                    value="Identidade Militar">
                                                    Identidade Militar</option>
                                                <option {{ $comprador2->tipo_documento == 'OAB' ? 'selected' : '' }}
                                                    value="OAB">
                                                    OAB</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <label>Profissão</label>
                                            <input value="{{ $comprador2->profissao }}" type="text"
                                                name="comprador2[profissao]" placeholder="Profissão"
                                                class="form-control form-control-border">
                                        </div>
                                    ...
                                    <div class="row mt-3" @if ($comprador2->estado_civil != 2 || $comprador2->estado_civil != 3) style="display:none;" @endif>
                                        <div class="col-6 dados-casamento-2">
                                            <label>Regime de bens</label>
                                            <select name="comprador2[regime_bens]"
                                                class="custom-select form-control form-control-border">
                                                <option value="">Selecione</option>
                                                <option value="1" @if ($comprador2->regime_bens == 1) selected @endif>
                                                    Comunhão
                                                    Parcial de Bens</option>
                                                <option value="2" @if ($comprador2->regime_bens == 2) selected @endif>
                                                    Comunhão
                                                    Universal de Bens</option>
                                                <option value="3" @if ($comprador2->regime_bens == 3) selected @endif>
                                                    Separação Total
                                                    de Bens</option>
                                                <option value="4" @if ($comprador2->regime_bens == 4) selected @endif>
                                        ...
                                        <div class="col-6">
                                            <label>Data casamento</label>
                                            <input type="date" name="comprador2[data_casamento]"
                                                value="{{ $comprador2->data_casamento }}" placeholder=""
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-3">
                                            <label>CEP Residencial</label>
                                            <input type="text" name="endereco_comprador2[cep]"
                                                value="{{ $enderecoComprador2->cep }}" placeholder="CEP" id="cep2"
                                                class="form-control form-control-border" onkeyup="pesquisacep(2)">
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-4">
                                            <label>Estado</label>
                                            <select name="endereco_comprador2[uf]" id="uf2"
                                                class="custom-select form-control form-control-border">
                                                @foreach ($ufs as $k => $v)
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Telefone</label>
                                            <input type="text" name="endereco_comprador2[telefone]"
                                                value="{{ $enderecoComprador2->telefone }}" placeholder=""
                                                class="form-control form-control-border telefone">
                                        </div>

                                        <div class="col-4">
                                            <label>Celular</label>
                                            <input type="text" name="endereco_comprador2[celular]"
                                                value="{{ $enderecoComprador2->celular }}" placeholder=""
                                                class="form-control form-control-border celular">
                                        </div>

                                        <div class="col-4">
                                            <label>E-mail</label>
                                            <input type="text" name="comprador2[email]"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="profissao_comprador2[nome_empresa]"
                                                value="{{ $profissaoComprador2->nome_empresa }}"
                                                placeholder="Nome da empresa" class="form-control form-control-border">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <select name="profissao_comprador2[contratacao]"
                                                class="custom-select form-control form-control-border">
                                                <option value="1"
                                                    {{ $profissaoComprador2->contratacao == 1 ? 'selected' : '' }}>
                                                    Assalariado
                                                </option>
                                                <option value="2"
                                                    {{ $profissaoComprador2->contratacao == 2 ? 'selected' : '' }}>
                                                    Aposentado
                                                </option>
                                                <option value="3"
                                                    {{ $profissaoComprador2->contratacao == 3 ? 'selected' : '' }}>
                                                    Sócio
                                                    Proprietário</option>
                                                <option value="4"
                                                    {{ $profissaoComprador2->contratacao == 4 ? 'selected' : '' }}>
                                                    Autônomo
                                                </option>
                                                <option value="5"
                                                    {{ $profissaoComprador2->contratacao == 5 ? 'selected' : '' }}>
                                                    Profissional
                                                    liberal</option>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="date" name="profissao_comprador2[admissao]"
                                                value="{{ $profissaoComprador2->admissao }}"
                                                class="form-control form-control-border">
                                        </div>
                                        {{-- <div class="col-4">
                    <label>Cargo</label>
                    <input type="text" name="profissao_comprador2[cargo]" value="{{ $profissaoComprador2->cargo }}"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="profissao_comprador2[renda_mensal]"
                                                value="{{ $profissaoComprador2->renda_mensal }}"
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="profissao_comprador2[outra_renda_mensal]"
                                                value="{{ $profissaoComprador2->outra_renda_mensal }}"
                                                placeholder="Outra renda mensal"
                                                class="form-control form-control-border decimal">
                                        </div>
                                        <div class="col-4">
                                ...
                                <div class="card card-navy conjuge2">
                                    ...
                                    <div class="card-body">
                                        <div class="row mt-2">
                                            <div class="col-6">
                                                <label>CPF </label>
                                                <input type="text" value="{{ $conjugeComprador2->cpf }}"
                                                    name="conjuge2[cpf]" placeholder="CPF"
                                                    class="form-control form-control-border cpf">
                                            </div>
                                            <div class="col-6">
                                                <label>Data de Nascimento</label>
                                                <input type="date" value="{{ $conjugeComprador2->data_nascimento }}"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label>Nome</label>
                                                <input type="text" name="conjuge2[nome]"
                                                    value="{{ $conjugeComprador2->nome }}" placeholder="CPF"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-6">
                                                <label>Sexo</label>
                                                <select name="conjuge2[sexo]"
                                                    class="custom-select form-control form-control-border">
                                                    <option value="1"
                                                        @if ($conjugeComprador2->sexo == 1) selected @endif>
                                                        Masculino
                                                    </option>
                                                    <option value="2"
                                                        @if ($conjugeComprador2->sexo == 2) selected @endif>
                                                        Feminino
                                                    </option>
                                                </select>
                                            </div>
                                            {{-- <div class="col-4">
                                                <label>Nome da mãe</label>
                                                <input type="text" name="conjuge2[nome_mae]"
                                                    value="{{ $conjugeComprador2->nome_mae }}" placeholder="Nome da mãe"
                                                    class="form-control form-control-border">
                                            </div> --}}
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                ...
                                                <select name="conjuge2[pais]" placeholder="Nacionalidade"
                                                    ...
                                                    @foreach ($nacionalidades as $n)
                                                        <option value="{{ $n }}"
                                                            {{ $conjugeComprador2->pais == $n ? 'selected' : '' }}>
                                                            {{ $n }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-6">
                                                <label>Naturalidade</label>
                                                <input type="text" name="conjuge2[naturalidade]"
                                                    value="{{ $conjugeComprador2->naturalidade }}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                ...
                                                <select class="custom-select form-control form-control-border"
                                                    ...
                                                    <option value="">Selecione</option>
                                                    <option
                                                        {{ $conjugeComprador2->tipo_documento == 'RG' ? 'selected' : '' }}
                                                        value="RG">
                                                        RG</option>
                                                    <option
                                                        {{ $conjugeComprador2->tipo_documento == 'CNH' ? 'selected' : '' }}
                                                        value="CNH">
                                                        CNH</option>
                                                    <option
                                                        {{ $conjugeComprador2->tipo_documento == 'Carteira Funcional' ? 'selected' : '' }}
                                                        value="Carteira Funcional">
                                                        Carteira Funcional</option>
                                                    <option
                                                        {{ $conjugeComprador2->tipo_documento == 'Identidade Militar' ? 'selected' : '' }}
                                                        value="Identidade Militar">
                                                        Identidade Militar</option>
                                                    <option
                                                        {{ $conjugeComprador2->tipo_documento == 'OAB' ? 'selected' : '' }}
                                                        value="OAB">
                                                        OAB</option>
                                                </select>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="conjuge2[num_documento]"
                                                    value="{{ $conjugeComprador2->num_documento }}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                ...
                                                <input type="text" name="conjuge2[orgao_emissor]"
                                                    value="{{ $conjugeComprador2->orgao_emissor }}"
                                            ...
                                            <div class="col-4">
                                                <label>Data emissão</label>
                                                <input type="date" name="conjuge2[data_emissao]"
                                                    value="{{ $conjugeComprador2->data_emissao }}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label>Telefone</label>
                                                <input type="text" name="conjuge2[telefone]"
                                                    value="{{ $conjugeComprador2->telefone }}" placeholder="Telefone"
                                                    class="form-control form-control-border telefone">
                                            </div>

                                            <div class="col-4">
                                                <label>Celular</label>
                                                <input type="text" name="conjuge2[celular]"
                                                    value="{{ $conjugeComprador2->celular }}" placeholder="Celular"
                                                    class="form-control form-control-border celular">
                                            </div>

                                            <div class="col-4">
                                                <label>E-mail</label>
                                                <input type="text" name="conjuge2[email]"
                                                    value="{{ $conjugeComprador2->email }}" placeholder="E-mail"
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                ...
                                <div class="card card-navy ">
                                    ...
                                    <div class="card-body" id="conj-compr">
                                        <div class="row">
                                            <div class="col-12">
                                                <label>Nome da empresa</label>
                                                <input type="text" name="conjuge2[nome_empresa]"
                                                    value="{{ $conjugeComprador2->nome_empresa }}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                ...
                                                <select name="conjuge2[contratacao]"
                                                    class="custom-select form-control form-control-border">
                                                    <option value="1"
                                                        {{ $conjugeComprador2->contratacao == 1 ? 'selected' : '' }}>
                                                        Assalariado</option>
                                                    <option value="2"
                                                        {{ $conjugeComprador2->contratacao == 2 ? 'selected' : '' }}>
                                                        Aposentado</option>
                                                    <option value="3"
                                                        {{ $conjugeComprador2->contratacao == 3 ? 'selected' : '' }}>
                                                        Sócio
                                                        Proprietário</option>
                                                    <option value="4"
                                                        {{ $conjugeComprador2->contratacao == 4 ? 'selected' : '' }}>
                                                        Autônomo
                                                    </option>
                                                    <option value="5"
                                                        {{ $conjugeComprador2->contratacao == 6 ? 'selected' : '' }}>
                                                        Profissional liberal</option>
                                                </select>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <input type="date" name="conjuge2[admissao]"
                                                    value="{{ $conjugeComprador2->admissao }}"
                                                    class="form-control form-control-border">
                                            </div>
                                            {{-- <div class="col-4">
                        <label>Cargo</label>
                        <input type="text" name="conjuge2[cargo]" value="{{ $conjugeComprador2->cargo }}"
                            placeholder="Cargo" class="form-control form-control-border">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label>Renda mensal</label>
                                                <input type="text" name="conjuge2[renda_mensal]"
                                                    value="{{ $conjugeComprador2->renda_mensal }}"
                                                    placeholder="Renda mensal"
                                                    class="form-control form-control-border decimal">
                                            </div>
                                            <div class="col-4">
                                                ...
                                                <input type="text" name="conjuge2[outra_renda_mensal]"
                                                    value="{{ $conjugeComprador2->outra_renda_mensal }}"
                                                    placeholder="Outra renda mensal"
                                                    class="form-control form-control-border decimal">
                                            </div>
                                            <div class="col-4">
                                                <label>Origem</label>
                                                <input type="text" name="conjuge2[origem_renda]"
                                                    value="{{ $conjugeComprador2->origem_renda }}" placeholder="Origem"
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                ...
                                <div class="card card-navy conjuge2" style="display:none;">
                                    ...
                                    <div class="card-body">
                                        <div class="row mt-2">
                                            <div class="col-6">
                                                <label>CPF</label>
                                                <input type="text" value="{{ old('conjuge2.cpf') }}"
                                                    name="conjuge2[cpf]" placeholder="CPF"
                                                    class="form-control form-control-border cpf">
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                <label>Nome</label>
                                                <input type="text" value="{{ old('conjuge2.nome') }}"
                                                    name="conjuge2[nome]" placeholder="Nome"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-6">
                                                <label>Sexo</label>
                                                <select name="conjuge2[sexo]"
                                                    ...
                                                    <option value="">Selecione</option>
                                                    <option value="1"
                                                        {{ old('conjuge2.sexo') == 1 ? 'selected' : '' }}>
                                                        Masculino</option>
                                                    <option value="2"
                                                        {{ old('conjuge2.sexo') == 2 ? 'selected' : '' }}>
                                                        Feminino
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-4">
                                                <label>E-mail</label>
                                                <input type="text" value="{{ old('conjuge2.email') }}"
                                                    name="conjuge2[email]" placeholder=""
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                ...
                                                <select name="conjuge2[contratacao]"
                                                    ...
                                                    <option value="">Selecione</option>
                                                    <option value="1"
                                                        {{ old('conjuge2.contratacao') == 1 ? 'selected' : '' }}>
                                                        Assalariado</option>
                                                    <option value="2"
                                                        {{ old('conjuge2.contratacao') == 2 ? 'selected' : '' }}>
                                                        Aposentado</option>
                                                    <option value="3"
                                                        {{ old('conjuge2.contratacao') == 3 ? 'selected' : '' }}>
                                                        Sócio Proprietário</option>
                                                    <option value="4"
                                                        {{ old('conjuge2.contratacao') == 4 ? 'selected' : '' }}>
                                                        Autônomo</option>
                                                    <option value="5"
                                                        {{ old('conjuge2.contratacao') == 5 ? 'selected' : '' }}>
                                                        Profissional liberal</option>
                                                </select>
                                            </div>
                                            <div class="col-6">
                        ...
                        @else
                            ...
                            <div class="card card-navy comprador2" style="display:none;">
                                ...
                                <div class="card-body">
                                    <input type="hidden" value="{{ old('comprador2.ativo') }}"
                                        id="seleciona-comprador-2" name="comprador2[ativo]">
                                    <div class="row">
                                        <div class="col-4">
                                            <label>CPF comprador </label>
                                            <input type="text" value="{{ old('comprador2.cpf') }}"
                                                name="comprador2[cpf]" placeholder="CPF"
                                                class="form-control form-control-border cpf">
                                        </div>
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <select name="comprador2[estado_civil]" onchange="setEstadoCivil2()"
                                                ...
                                                <option value="">Selecione</option>
                                                <option value="1"
                                                    {{ old('comprador2.estado_civil') == 1 ? 'selected' : '' }}>
                                                    Solteiro(a)
                                                </option>
                                                <option value="2"
                                                ...
                                                <option value="5"
                                                    ...
                                                    Viúvo(a)</option>
                                                <option value="6"
                                                    {{ old('comprador2.estado_civil') == 6 ? 'selected' : '' }}>
                                                    Separado(a)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            <label>Nome</label>
                                            <input type="text" value="{{ old('comprador2.nome') }}"
                                                name="comprador2[nome]" placeholder="Nome"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <select name="comprador2[sexo]"
                                                ...
                                                <option value="">Selecione</option>
                                                <option value="1"
                                                    {{ old('comprador2.sexo') == 1 ? 'selected' : '' }}>
                                                    Masculino</option>
                                                <option value="2"
                                                    {{ old('comprador2.sexo') == 2 ? 'selected' : '' }}>
                                                    Feminino</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-4">
                                            <label>Profissão</label>
                                            <input value="{{ old('comprador2.profissao') }}" type="text"
                                                name="comprador2[profissao]" placeholder="Profissão"
                                                class="form-control form-control-border">
                                        </div>
                                    ...
                                    <div class="row mt-3 dados-casamento2" style="display:none;">
                                        <div class="col-6">
                                            ...
                                            <select name="comprador2[regime_bens]"
                                                class="custom-select form-control form-control-border">
                                                <option value="">Selecione</option>
                                                <option {{ old('comprador2.regime_bens') == 1 ? 'selected' : '' }}
                                                    value="1">
                                                    Comunhão Parcial de Bens</option>
                                                <option {{ old('comprador2.regime_bens') == 2 ? 'selected' : '' }}
                                                    value="2">
                                                    Comunhão Universal de Bens</option>
                                                <option {{ old('comprador2.regime_bens') == 3 ? 'selected' : '' }}
                                                    value="3">
                                                    Separação Total de Bens</option>
                                                <option {{ old('comprador2.regime_bens') == 4 ? 'selected' : '' }}
                                                    value="4">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-3">
                                            ...
                                            <input type="text" value="{{ old('endereco_comprador2.cep') }}"
                                                onkeyup="pesquisacep(2)" name="endereco_comprador2[cep]"
                                                id="cep2" placeholder=""
                                                class="form-control form-control-border">
                                        </div>
                                ...
                                <div class="card-body collapse" id="test-block2">
                                    <div class="row">
                                        <div class="col-12">
                                            <label>Nome da empresa</label>
                                            <input type="text"
                                                value="{{ old('profissao_comprador2.nome_empresa') }}"
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="date" value="{{ old('profissao_comprador2.admissao') }}"
                                                name="profissao_comprador2[admissao]"
                                                class="form-control form-control-border">
                                        </div>
                                        {{-- <div class="col-4">
                    <label>Cargo</label>
                        ...
                        name="profissao_comprador2[cargo]" placeholder="Cargo" class="form-control form-control-border">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Renda mensal</label>
                                            <input type="text"
                                                value="{{ old('profissao_comprador2.renda_mensal') }}"
                                        ...
                                        <div class="col-4">
                                            <label>Outra renda mensal</label>
                                            <input type="text"
                                                value="{{ old('profissao_comprador2.outra_renda_mensal') }}"
                                                name="profissao_comprador2[outra_renda_mensal]"
                                                placeholder="Outra renda mensal"
                                                class="form-control form-control-border decimal">
                                        </div>
                                        <div class="col-4">
                                            <label>Origem</label>
                                            <input type="text"
                                                value="{{ old('profissao_comprador2.origem_renda') }}"
                        ...
                        <div class="card card-navy ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="vendedor[tipo]" onchange="tipoVendedor()" id="vendedor_tipo"
                                            class="custom-select form-control form-control-border">
                                            <option value="1" @if ($vendedor->tipo == 1) selected @endif>
                                                Pessoa
                                                Física
                                            </option>
                                            <option value="2" @if ($vendedor->tipo == 2) selected @endif>
                                                Pessoa
                                                Jurídica
                                            </option>
                                        </select>
                                ...
                                <div class="pessoa-fisica"
                                    @if ($vendedor->tipo == 2) style="display: none;" @endif>
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Nome</label>
                                            <input type="text" name="vendedor[nome]"
                                                value="{{ $vendedor->nome }}" placeholder="Nome do vendedor"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label>Estado Civil</label>
                                            <select name="vendedor[estado_civil]"
                                                class="custom-select form-control form-control-border">
                                                <option value="1"
                                                    @if ($vendedor->estado_civil == 1) selected @endif>
                                                    Solteiro(a)</option>
                                                <option value="2"
                                                    @if ($vendedor->estado_civil == 2) selected @endif>
                                                    Casado(a)</option>
                                                <option value="3"
                                                    @if ($vendedor->estado_civil == 3) selected @endif>União
                                                    estável</option>
                                                <option value="4"
                                                    @if ($vendedor->estado_civil == 4) selected @endif>
                                                    Divorciado(a)</option>
                                                <option value="5"
                                                    @if ($vendedor->estado_civil == 5) selected @endif>
                                                    Viúvo(a)</option>
                                                <option value="6"
                                                    @if ($vendedor->estado_civil == 6) selected @endif>
                                                    Separado(a)</option>
                                            </select>
                                        </div>
                                        <div class="col-4">
                                            <label>CPF</label>
                                            <input type="text" name="vendedor[cpf]" value="{{ $vendedor->cpf }}"
                                                placeholder="CPF" class="form-control form-control-border cpf">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Celular</label>
                                            <input type="text" name="vendedor[telefone]"
                                                value="{{ $vendedor->telefone }}" placeholder="Celular"
                                                class="form-control form-control-border celular">
                                        </div>
                                        <div class="col-4">
                                            <label>Email</label>
                                            <input type="email" value="{{ $vendedor->email }}"
                                                name="vendedor[email]" placeholder="E-mail"
                                                class="form-control form-control-border ">
                                        </div>
                                        <div class="col-4">
                                            <label>Profissão</label>
                                            <input type="text" name="vendedor[profissao]"
                                                value="{{ $vendedor->profissao }}" placeholder="Profissão"
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="vendedor[banco]"
                                                value="{{ $vendedor->banco }}" placeholder="Banco"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label for="agencia">Agência</label>
                                            <input type="text" name="vendedor[agencia]"
                                                value="{{ $vendedor->agencia }}" placeholder="Agência"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label for="conta">Conta</label>
                                            <input type="text" name="vendedor[conta]"
                                                value="{{ $vendedor->conta }}" placeholder="Conta"
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            ...
                                            <select onchange="selectProcurador(1)" id="possui-procurador"
                                                name="vendedor[procurador]"
                                                class="custom-select form-control form-control-border">
                                                <option>Selecione</option>
                                                <option value="1"
                                                    @if ($vendedor->procurador == 1) selected @endif>Sim
                                                </option>
                                                <option value="0"
                                                    @if ($vendedor->procurador == 0) selected @endif>Não
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="sessao-procurador-1"
                                        @if ($vendedor->procurador == 0) style="display:none;" @endif>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                ...
                                                <input type="text" name="vendedor[nome_procurador]"
                                                    value="{{ $vendedor->nome_procurador }}"
                                                    placeholder="Nome Procurador"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="">Tipo procurador</label>
                                                <select name="vendedor[tipo_procurador]"
                                                    onchange="tipoProcurador('sessao-procurador-1')"
                                                    class="custom-select form-control form-control-border"
                                                    id="tipo-procurador">
                                                    <option>Selecione</option>
                                                    <option value="0"
                                                        {{ $vendedor->tipo_procurador != 1 ? 'selected' : '' }}>Pessoa
                                                        Física</option>
                                                    <option value="1"
                                                        {{ $vendedor->tipo_procurador == 1 ? 'selected' : '' }}>Pessoa
                                                        Jurídica</option>
                                            ...
                                            <div class="col-4">
                                                <label for=""
                                                    id="label-target-tipo">{{ $vendedor->tipo_procurador != 1 ? 'CPF Procurador' : 'CNPJ Procurador' }}</label>
                                                <input type="text" name="vendedor[cpf_procurador]"
                                                    value="{{ $vendedor->cpf_procurador }}"
                                                    placeholder="CPF Procurador"
                                                    class="form-control form-control-border {{ $vendedor->tipo_procurador != 1 ? 'cpf' : 'cnpj' }}"
                                                    id="target-tipo">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                ...
                                                <input type="email" name="vendedor[email_procurador]"
                                                    value="{{ $vendedor->email_procurador }}"
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="vendedor[telefone_procurador]"
                                                    value="{{ $vendedor->telefone_procurador }}"
                                                    placeholder="Celular Procurador"
                                                    class="form-control form-control-border celular">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="pessoa-juridica"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="vendedor_cnpj[nome]"
                                                value="{{ $vendedor->nome }}" placeholder="Razão Social"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label>CNPJ</label>
                                            <input type="text" name="vendedor_cnpj[cnpj]"
                                                value="{{ $vendedor->cnpj }}" placeholder="CNPJ"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Telefone</label>
                                            <input type="text" name="vendedor_cnpj[telefone]"
                                                value="{{ $vendedor->telefone }}" placeholder="Telefone"
                                                class="form-control form-control-border telefone">
                                        </div>
                                        <div class="col-6">
                                            <label>Email</label>
                                            <input type="email" value="{{ $vendedor->email }}"
                                                name="vendedor_cnpj[email]" placeholder="E-mail"
                                                class="form-control form-control-border ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label for="banco">Banco</label>
                                            <input type="text" name="vendedor_cnpj[banco]"
                                                value="{{ $vendedor->banco }}" placeholder="Banco"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label for="agencia">Agência</label>
                                            <input type="text" name="vendedor_cnpj[agencia]"
                                                value="{{ $vendedor->agencia }}" placeholder="Agência"
                                                class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label for="conta">Conta</label>
                                            <input type="text" name="vendedor_cnpj[conta]"
                                                value="{{ $vendedor->conta }}" placeholder="Conta"
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <label for="">Possui procurador?</label>
                                            <select name="vendedor_cnpj[procurador]" onchange="selectProcurador(2)"
                                                id="possui-procurador2"
                                                class="custom-select form-control form-control-border">
                                                <option>Selecione</option>
                                                <option value="1"
                                                    @if ($vendedor->procurador == 1) selected @endif>Sim
                                    ...
                                    <div class="sessao-procurador-2"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-4">
                                                <label for="">Tipo procurador</label>
                                                <select name="vendedor_cnpj[tipo_procurador]"
                                                    onchange="tipoProcurador('sessao-procurador-2')"
                                                    class="custom-select form-control form-control-border"
                                                    id="tipo-procurador">
                                                    <option>Selecione</option>
                                                    <option value="0"
                        ...
                        @if (!$vendedor2)
                            <div class="row justify-content-end mb-2">
                                <div class="col-12 col-md-3 pull-right">
                                    ...
                                    <button type="button" class="btn btn-block btn-outline-primary"
                                        onclick="addVendedor2()"><i class='fas fa-plus'></i> Vendedor</button>
                                </div>
                            </div>
                        @endif
                        @if ($vendedor2)
                            <div class="card card-navy ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label>Tipo de vendedor</label>
                                            <select name="vendedor2[tipo]" onchange="tipoVendedor()"
                                                id="vendedor_tipo"
                                                class="custom-select form-control form-control-border">
                                                <option value="1"
                                                    @if ($vendedor2->tipo == 1) selected @endif>Pessoa
                                                    Física
                                                </option>
                                                <option value="2"
                                                    @if ($vendedor2->tipo == 2) selected @endif>Pessoa
                                                    Jurídica
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="pessoa-fisica"
                                        @if ($vendedor2->tipo == 2) style="display: none;" @endif>
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label>Nome</label>
                                                <input type="text" name="vendedor2[nome]"
                                                    value="{{ $vendedor2->nome }}" placeholder="Nome do vendedor"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label>Estado Civil</label>
                                                <select name="vendedor2[estado_civil]"
                                                    class="custom-select form-control form-control-border">
                                                    <option value="1"
                                                        @if ($vendedor2->estado_civil == 1) selected @endif>
                                                        Solteiro(a)</option>
                                                    <option value="2"
                                                        @if ($vendedor2->estado_civil == 2) selected @endif>
                                                        Casado(a)</option>
                                                    <option value="3"
                                                        @if ($vendedor2->estado_civil == 3) selected @endif>
                                                        União
                                                        estável</option>
                                                    <option value="4"
                                                        @if ($vendedor2->estado_civil == 4) selected @endif>
                                                        Divorciado(a)</option>
                                                    <option value="5"
                                                        @if ($vendedor2->estado_civil == 5) selected @endif>
                                                        Viúvo(a)</option>
                                                    <option value="6"
                                                        @if ($vendedor2->estado_civil == 6) selected @endif>
                                                        Separado(a)</option>
                                                </select>
                                            </div>
                                            <div class="col-4">
                                                <label>CPF</label>
                                                <input type="text" name="vendedor2[cpf]"
                                                    value="{{ $vendedor2->cpf }}" placeholder="CPF"
                                                    class="form-control form-control-border cpf">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-3">
                                                <label>Celular</label>
                                                <input type="text" name="vendedor2[telefone]"
                                                    value="{{ $vendedor2->telefone }}" placeholder="Celular"
                                                    class="form-control form-control-border celular">
                                            </div>
                                            <div class="col-3">
                                                <label>Email</label>
                                                <input type="email" value="{{ $vendedor2->email }}"
                                            ...
                                            <div class="col-3">
                                                <label>Profissão</label>
                                                <input type="text" name="vendedor2[profissao]"
                                                    value="{{ $vendedor2->profissao }}" placeholder="Profissão"
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label for="banco">Banco</label>
                                                <input type="text" name="vendedor2[banco]"
                                                    value="{{ $vendedor2->banco }}" placeholder="Banco"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="agencia">Agência</label>
                                                <input type="text" name="vendedor2[agencia]"
                                                    value="{{ $vendedor2->agencia }}" placeholder="Agência"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="conta">Conta</label>
                                                <input type="text" name="vendedor2[conta]"
                                                    value="{{ $vendedor2->conta }}" placeholder="Conta"
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <label for="">Possui procurador?</label>
                                                <select onchange="selectProcurador2(1)" id="possui-procurador-outro"
                                                    name="vendedor2[procurador]"
                                                    class="custom-select form-control form-control-border">
                                                    <option>Selecione</option>
                                                    <option value="1"
                                                        @if ($vendedor2->procurador == 1) selected @endif>
                                                        Sim</option>
                                                    <option value="0"
                                                        @if ($vendedor2->procurador == 0) selected @endif>
                                                        Não</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="sessao-procurador-1-outro"
                                            @if ($vendedor2->procurador == 0) style="display:none;" @endif>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" name="vendedor2[nome_procurador]"
                                                        value="{{ $vendedor2->nome_procurador }}"
                                                        placeholder="Nome Procurador"
                                                        class="form-control form-control-border">
                                                </div>
                                                <div class="col-4">
                                                    <label for="">Tipo procurador</label>
                                                    <select name="vendedor2[tipo_procurador]"
                                                        onchange="tipoProcurador('sessao-procurador-1-outro')"
                                                        class="custom-select form-control form-control-border"
                                                        id="tipo-procurador">
                                                        <option>Selecione</option>
                                                        <option value="0"
                                                            {{ $vendedor2->tipo_procurador != 1 ? 'selected' : '' }}>
                                                ...
                                                <div class="col-4">
                                                    <label for=""
                                                        id="label-target-tipo">{{ $vendedor2->tipo_procurador != 1 ? 'CPF Procurador' : 'CNPJ Procurador' }}</label>
                                                    <input type="text" name="vendedor2[cpf_procurador]"
                                                        value="{{ $vendedor2->cpf_procurador }}"
                                                        placeholder="CPF Procurador"
                                                        class="form-control form-control-border  {{ $vendedor2->tipo_procurador != 1 ? 'cpf' : 'cnpj' }}"
                                                        id="target-tipo">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-6">
                                                    ...
                                                    <input type="email" name="vendedor2[email_procurador]"
                                                        value="{{ $vendedor2->email_procurador }}"
                                                        placeholder="E-mail Procurador"
                                                        class="form-control form-control-border">
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" name="vendedor2[telefone_procurador]"
                                                        value="{{ $vendedor2->telefone_procurador }}"
                                                        placeholder="Celular Procurador"
                                                        class="form-control form-control-border celular">
                                                </div>
                                            </div>
                                    ...
                                    <div class="pessoa-juridica"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label>Razão social</label>
                                                <input type="text" name="vendedor2_cnpj[nome]"
                                                    value="{{ $vendedor2->nome }}"
                                                    placeholder=" Razão
                                                                                Social"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label>CNPJ</label>
                                                <input type="text" name="vendedor2_cnpj[cnpj]"
                                                    value="{{ $vendedor2->cnpj }}" placeholder=" CNPJ"
                                                    class="form-control form-control-border cnpj">
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="vendedor2_cnpj[telefone]"
                                                    value="{{ $vendedor2->telefone }}" placeholder="Telefone"
                                                    class="form-control form-control-border celular">
                                            </div>
                                            <div class="col-6">
                                                <label>Email</label>
                                                <input type="email" value="{{ $vendedor2->email }}"
                                                    name="vendedor2_cnpj[email]" placeholder="E-mail"
                                                    class="form-control form-control-border ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label for="banco">Banco</label>
                                                <input type="text" name="vendedor2_cnpj[banco]"
                                                    value="{{ $vendedor2->banco }}" placeholder="Banco"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="agencia">Agência</label>
                                                <input type="text" name="vendedor2_cnpj[agencia]"
                                                    value="{{ $vendedor2->agencia }}" placeholder="Agência"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="conta">Conta</label>
                                                <input type="text" name="vendedor2_cnpj[conta]"
                                                    value="{{ $vendedor2->conta }}" placeholder="Conta"
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <label for="">Possui procurador?</label>
                                                <select name="vendedor2_cnpj[procurador]"
                                        ...
                                        <div class="sessao-procurador-2-outro"
                                            @if ($vendedor2->procurador == 0) style="display:none;" @endif>

                                            <div class="row mt-3">
                                                <div class="col-4">
                                                    <label for="">Nome Procurador</label>
                                                    <input type="text" name="vendedor2_cnpj[nome_procurador]"
                                                        value="{{ $vendedor2->nome_procurador }}"
                                                        placeholder="Nome Procurador"
                                                        class="form-control form-control-border">
                                                </div>
                                                <div class="col-4">
                                                    <label for="">Tipo procurador</label>
                                                    <select name="vendedor2_cnpj[tipo_procurador]"
                                                        onchange="tipoProcurador('sessao-procurador-2-outro')"
                                                        class="custom-select form-control form-control-border"
                                                        id="tipo-procurador">
                                                        <option>Selecione</option>
                                                        <option value="0"
                                                ...
                                                <div class="col-4">
                                                    <label for=""
                                                        id="label-target-tipo">{{ $vendedor2->tipo_procurador != 1 ? 'CPF Procurador' : 'CNPJ Procurador' }}</label>
                                                    <input type="text" name="vendedor2_cnpj[cpf_procurador]"
                                                        value="{{ $vendedor2->cpf_procurador }}"
                                                        placeholder="CPF Procurador"
                                                        class="form-control form-control-border {{ $vendedor2->tipo_procurador != 1 ? 'cpf' : 'cnpj' }}"
                                                        id="target-tipo">
                            ...
                            <div class="card card-navy " id="vendedor2" style="display: none;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <label>Tipo de vendedor</label>
                                            <select name="vendedor2[tipo]" onchange="tipoVendedor2()"
                                                id="vendedor_tipo"
                                                class="custom-select form-control form-control-border">
                                                <option value="">Selecione</option>
                                    ...
                                    <div class="pessoa-fisica" style="display: none;">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select name="vendedor2[estado_civil]"
                                                    ...
                                                    <option value="1"
                                                        ...
                                                        Solteiro(a)</option>
                                                    <option value="2"
                                                        {{ old('vendedor2.estado_civil') == 2 ? 'selected' : '' }}>
                                                        Casado(a)
                                                    </option>
                                                    <option value="3"
                                                    ...
                                                    <option value="4"
                                                        ...
                                                        Divorciado(a)</option>
                                                    <option value="5"
                                                        {{ old('vendedor2.estado_civil') == 5 ? 'selected' : '' }}>
                                                        Viúvo(a)
                                                    </option>
                                                
                                                    <option value="6"
                                                        {{ old('vendedor2.estado_civil') == 6 ? 'selected' : '' }}>
                                                        Separado(a)
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-4">
                                                <label>CPF</label>
                                                <input type="text" value="{{ old('vendedor2.cpf') }}"
                                                    name="vendedor2[cpf]" placeholder="CPF"
                                                    class="form-control form-control-border cpf">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sessao-procurador-1-outro" style="display: none;">
                                            <div class="row mt-3">
                                                <div class="col-4">
                                                    <label for="">Nome Procurador</label>
                                                    <input type="text"
                                                        value="{{ old('vendedor2.nome_procurador') }}"
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text"
                                                        value="{{ old('vendedor2.cpf_procurador') }}"
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-6">
                                                    <label for="">E-mail Procurador</label>
                                                    <input type="email"
                                                        value="{{ old('vendedor2.email_procurador') }}"
                                                        name="vendedor2[email_procurador]"
                                                        placeholder="E-mail Procurador"
                                                        class="form-control form-control-border">
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <input type="text"
                                                        value="{{ old('vendedor2.telefone_procurador') }}"
                                                        name="vendedor2[telefone_procurador]"
                                                        placeholder="Celular Procurador"
                                                        class="form-control form-control-border celular">
                                                </div>
                                            </div>
                                    ...
                                    <div class="pessoa-juridica" style="display: none;">
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label>Razão social</label>
                                                <input type="text" value="{{ old('vendedor2_cnpj.nome') }}"
                                                    name="vendedor2_cnpj[nome]" placeholder="Razão Social"
                                                    class="form-control form-control-border">
                                            </div>

                                            <div class="col-4">
                                                <label>CNPJ</label>
                                                <input type="text" value="{{ old('vendedor2_cnpj.cnpj') }}"
                                                    name="vendedor2_cnpj[cnpj]" placeholder="CNPJ"
                                                    class="form-control form-control-border cnpj">
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-6">
                                                <label>Celular</label>
                                                <input type="text" value="{{ old('vendedor2.telefone') }}"
                                                    name="vendedor2_cnpj[telefone]" placeholder="Telefone"
                                                    class="form-control form-control-border celular">
                                            </div>
                                            <div class="col-6">
                                                <label>Email</label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                <label for="banco">Banco</label>
                                                <input type="text" value="{{ old('vendedor2.banco') }}"
                                                    name="vendedor2_cnpj[banco]" placeholder="Banco"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="agencia">Agência</label>
                                                <input type="text" value="{{ old('vendedor2.agencia') }}"
                                                    name="vendedor2_cnpj[agencia]" placeholder="Agência"
                                                    class="form-control form-control-border">
                                            </div>
                                            <div class="col-4">
                                                <label for="conta">Conta</label>
                                                <input type="text" value="{{ old('vendedor2.conta') }}"
                                                    name="vendedor2_cnpj[conta]" placeholder="Conta"
                                                    class="form-control form-control-border">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sessao-procurador-2-outro" style="display: none;">
                                            <div class="row mt-3">
                                                <div class="col-4">
                                                    ...
                                                    <input type="text"
                                                        value="{{ old('vendedor2.nome_procurador') }}"
                                                        name="vendedor2_cnpj[nome_procurador]"
                                                        placeholder="Nome Procurador"
                                                        class="form-control form-control-border">
                                                </div>
                                                <div class="col-4">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text"
                                                        value="{{ old('vendedor2.cpf_procurador') }}"
                                                        name="vendedor2_cnpj[cpf_procurador]"
                                                        placeholder="CPF Procurador"
                                                        class="form-control form-control-border cpf" id="target-tipo">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-6">
                                                    ...
                                                    <input type="email"
                                                        value="{{ old('vendedor2.email_procurador') }}"
                                                        name="vendedor2_cnpj[email_procurador]"
                                                        placeholder="E-mail Procurador"
                                                        class="form-control form-control-border">
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <input type="text"
                                                        value="{{ old('vendedor2.telefone_procurador') }}"
                                                        name="vendedor2_cnpj[telefone_procurador]"
                                                        placeholder="Celular Procurador"
                                                        class="form-control form-control-border celular">
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="row mt-3">
                                    <div class="col-3">
                                        ...
                                        <input type="text" name="imovel[cep]" value="{{ $imovel->cep }}"
                                            id="cep4" placeholder="CEP do imóvel" onkeyup="pesquisacep(4)"
                                            class="form-control form-control-border">
                                    </div>
                                    <div class="col-5">
                                        <label>Endereço</label>
                                        <input type="text" name="imovel[endereco]"
                                            value="{{ $imovel->endereco }}" id="rua4"
                                            placeholder="Endereço do imóvel" class="form-control form-control-border">
                                    </div>
                                    <div class="col-2">
                                        <label>Número</label>
                                        <input type="text" name="imovel[numero]" value="{{ $imovel->numero }}"
                                            placeholder="Número" id="numero4"
                                            class="form-control form-control-border">
                                    </div>
                                    <div class="col-2">
                                        <label>Complemento</label>
                                        <input type="text" name="imovel[complemento]"
                                            value="{{ $imovel->complemento }}" placeholder="Complemento"
                                            class="form-control form-control-border">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="imovel[bairro]" value="{{ $imovel->bairro }}"
                                            placeholder="Bairro" id="bairro4"
                                            class="form-control form-control-border">
                                    </div>
                                    <div class="col-4">
                                        <label>Cidade</label>
                                        <input type="text" name="imovel[cidade]" value="{{ $imovel->cidade }}"
                                            placeholder="Cidade" id="cidade4"
                                            class="form-control form-control-border">
                                    </div>
                                    <div class="col-4">
                                        <label>Estado</label>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="imovel[numero_vaga]"
                                            value="{{ $imovel->numero_vaga }}" placeholder="Número(s) vaga(s)"
                                            class="form-control form-control-border">
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="imovel[contato_avaliacao]"
                                            value="{{ $imovel->contato_avaliacao }}"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="imovel[telefone_contato]"
                                            value="{{ $imovel->telefone_contato }}" placeholder="Contato de avaliação"
                                            class="form-control form-control-border celular">
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="imovel[novo_usado]"
                                            class="custom-select form-control form-control-border">
                                            <option value="">Selecione</option>
                                            <option value="1" @if ($imovel->novo_usado == 1) selected @endif>
                                                Novo
                                            </option>
                                            <option value="2" @if ($imovel->novo_usado == 2) selected @endif>
                                                Usado
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-2 mr-2">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <input class="custom-control-input" type="radio" id="tipo_imovel1"
                                                name="processo[tipo_imovel]" value="1" {{ $checked1 }}>
                                    ...
                                    <div class="col-2">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="tipo_imovel2"
                                                name="processo[tipo_imovel]" value="2" {{ $checked2 }}>
                                    ...
                                    <div class="col-2">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="tipo_imovel3"
                                                name="processo[tipo_imovel]" value="3" {{ $checked3 }}>
                                    ...
                                    <div class="col-2">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="tipo_imovel4"
                                                name="processo[tipo_imovel]" value="4" {{ $checked4 }}>
                                    ...
                                    <div class="col-2">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="tipo_imovel5"
                                                name="processo[tipo_imovel]" value="5" {{ $checked5 }}>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="{{ $processo->valor_operacao }}"
                                            name="processo[valor_operacao]" placeholder="R$"
                                            class="form-control form-control-border decimal">
                                    </div>
                                    <div class="col-4">
                                        <label>Valor a financiar</label>
                                        <input type="text" name="processo[valor_financiar]"
                                            value="{{ $processo->valor_financiar }}" placeholder="R$"
                                            class="form-control form-control-border decimal">
                                    </div>
                                    <div class="col-2">
                                        <div class="custom-control custom-checkbox">
                                            @if ($processo->utiliza_fgts == 1)
                                                <input class="custom-control-input" type="checkbox"
                                                    onchange="campoFgts()" id="utilizar_fgts"
                                    ...
                                    <div class="col-2">
                                        <div class="custom-control custom-checkbox">
                                            @if ($processo->financiar_despesas == 1)
                                                <input class="custom-control-input" type="checkbox"
                                                    onchange="campoDespesas()" id="financiar_despesas"
                                    ...
                                    <div class="col-3">
                                        <div class="custom-control custom-checkbox">
                                            @if ($processo->financiar_avaliacao == 1)
                                                <input class="custom-control-input" type="checkbox"
                                                    id="financiar_tarifa" name="processo[financiar_avaliacao]"
                                                    value="1" checked>
                                            @else
                                                <input class="custom-control-input" type="checkbox"
                                                    id="financiar_tarifa" name="processo[financiar_avaliacao]"
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-6 valor_fgts"
                                        {{ $processo->utiliza_fgts != 1 ? 'style=display:none;' : '' }}>
                                    ...
                                    <div class="col-6 valor_despesas"
                                        ...
                                        <input type="text" value="{{ $processo->valor_despesas }}"
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="processo[recursos_proprios]"
                                            value="{{ $processo->recursos_proprios }}"
                                            placeholder="Valor Recursos Próprios"
                                            class="form-control form-control-border decimal">
                                    </div>
                                    <div class="col-6">
                                        <label>Valor total financiado</label>
                                        <input type="text" name="processo[valor_total_financiado]"
                                            value="{{ $processo->valor_total_financiado }}"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6">
                                        <label>Prazo</label>
                                        <input type="text" name="processo[meses_financiamento]"
                                            value="{{ $processo->meses_financiamento }}" placeholder="Meses"
                                            class="form-control form-control-border">
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select name="processo[banco]"
                                            class="custom-select form-control form-control-border">
                                            <option value="">Selecione</option>
                                            <option value="1" @if ($processo->banco == 1) selected @endif>
                                                Itaú
                                            </option>
                                            <option value="2" @if ($processo->banco == 2) selected @endif>
                                                Bradesco
                                            </option>
                                            <option value="3" @if ($processo->banco == 3) selected @endif>
                                                Santander
                                            </option>
                                            <option value="4" @if ($processo->banco == 4) selected @endif>
                                                Caixa
                                            </option>
                                            <option value="5" @if ($processo->banco == 5) selected @endif>
                                                Banrisul
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="number" min="1" max="31"
                                            name="processo[dia_prestacao]" value="{{ $processo->dia_prestacao }}"
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <select name="processo[amortizacao]"
                                            ...
                                            <option value="price" @if ($processo->amortizacao == 'price') selected @endif>
                                                Price
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <select name="processo[indexador]"
                                            class="custom-select form-control form-control-border">
                                            <option value="">Selecione</option>
                                            <option value="1" @if ($processo->indexador == 1) selected @endif>
                                                Poupança
                                            </option>
                                            <option value="2" @if ($processo->indexador == 2) selected @endif>TR
                                            </option>
                                            <option value="3" @if ($processo->indexador == 3) selected @endif>
                                                IPCA
                                            </option>
                                            <option value="4" @if ($processo->indexador == 4) selected @endif>
                                                Taxa Fixa
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        ...
                                        <textarea name="processo[observacoes]" class="form-control form-control-border" cols="30" rows="5">{{ $processo->observacoes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
