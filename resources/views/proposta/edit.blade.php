    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="conjuge[nome_mae]"
                                                value="{{ $conjugeComprador->nome_mae }}" placeholder="Nome da mãe"
                                                class="form-control form-control-border">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <select name="conjuge[contratacao]"
                                                class="custom-select form-control form-control-border">
                                                <option value="1" @if ($conjugeComprador->contratacao == 1) selected
                        @endif>Assalariado</option>
                        <option value="2" @if ($conjugeComprador->contratacao == 2)
                            selected
                            @endif>Aposentado</option>
                        <option value="3" @if ($conjugeComprador->contratacao == 3)
                            selected
                            @endif>Sócio Proprietário</option>
                        <option value="4" @if ($conjugeComprador->contratacao == 4)
                            selected
                            @endif>Autônomo</option>
                        <option value="5" @if ($conjugeComprador->contratacao == 5)
                            selected
                            @endif>Profissional liberal</option>
                        </select>
                </div>
                ...
                <div class="col-4">
                    <label>Cargo</label>
                    <input type="text" name="conjuge[cargo]" value="{{ $conjugeComprador->cargo }}" placeholder="Cargo"
                        class="form-control form-control-border">
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-4">
                    <label>Renda mensal</label>
                    <input type="text" name="conjuge[renda_mensal]" value="{{ $conjugeComprador->renda_mensal }}"
                ...
                <div class="col-4">
                    <label>Origem</label>
                    <input type="text" name="conjuge[origem_renda]" value="{{ $conjugeComprador->origem_renda }}"
        ...
        <div class="card card-navy ">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-4">
                        <label>CPF</label>
                        <input type="text" value="{{ $comprador2->cpf }}" name="comprador2[cpf]" placeholder="CPF"
                            class="form-control form-control-border">
                    </div>
                    <div class="col-4">
                        <label>Nome</label>
                        <input type="text" value="{{ $comprador2->nome }}" name="comprador2[nome]" placeholder="Nome"
                            class="form-control form-control-border">
                    </div>
                    <div class="col-4">
                        <label>Sexo</label>
                        <select name="comprador2[sexo]" class="custom-select form-control form-control-border">
                            <option value="">Selecione</option>
                            <option value="1" @if ($comprador2->sexo == 1) selected @endif>Masculino
                            </option>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6">
                        <label>Naturalidade</label>
                        <input type="text" name="comprador2[naturalidade]" value="{{ $comprador2->naturalidade }}"
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        <label>Documento</label>
                        <input type="text" name="comprador2[tipo_documento]" value="{{ $comprador2->tipo_documento }}"
                            placeholder="Documento" class="form-control form-control-border">

                    </div>
                    <div class="col-6">
                        <label>Nº Documento</label>
                        <input type="text" name="comprador2[num_documento]" value="{{ $comprador2->num_documento }}"
                ...
                <div class="row mt-3">
                    <div class="col-4">
                        <label>Órgão expedidor</label>
                        <input type="text" name="comprador2[orgao_emissor]" value="{{ $comprador2->orgao_emissor }}"
                            placeholder="Órgão expedidor" class="form-control form-control-border">
                    </div>
                    <div class="col-4">
                        <label>UF emissão</label>
                    ...
                    <div class="col-4">
                        <label>Data emissão</label>
                        <input type="date" name="comprador2[data_emissao]" value="{{ $comprador2->data_emissao }}"
                ...
                <div class="row mt-3">
                    <div class="col-4">
                        ...
                        <select name="profissao_comprador2[contratacao]"
                            class="custom-select form-control form-control-border">
                            <option value="1" {{ $profissaoComprador2->contratacao == 1 ? 'selected' : '' }}>Assalariado
                            </option>
                            <option value="2" {{ $profissaoComprador2->contratacao == 2 ? 'selected' : '' }}>Aposentado
                            </option>
                            <option value="3" {{ $profissaoComprador2->contratacao == 3 ? 'selected' : '' }}>Sócio
                                Proprietário</option>
                            <option value="4" {{ $profissaoComprador2->contratacao == 4 ? 'selected' : '' }}>Autônomo
                            </option>
                            <option value="5" {{ $profissaoComprador2->contratacao == 5 ? 'selected' : '' }}>Profissional
                                liberal</option>
                        </select>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="conjuge2[naturalidade]"
                                value="{{ $conjugeComprador2->naturalidade }}" placeholder="Naturalidade"
                                class="form-control form-control-border">
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" name="conjuge2[data_emissao]"
                                value="{{ $conjugeComprador2->data_emissao }}" placeholder="Data emissão"
                                class="form-control form-control-border">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" name="conjuge2[nome_empresa]"
                                value="{{ $conjugeComprador2->nome_empresa }}" placeholder="Nome da empresa"
                                class="form-control form-control-border">
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            ...
                            <input type="text" name="conjuge2[renda_mensal]"
                                value="{{ $conjugeComprador2->renda_mensal }}" placeholder="Renda mensal"
                                class="form-control form-control-border">
                        </div>
                        <div class="col-4">
                            <label>Outra renda mensal</label>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="comprador2[estado_civil]" onchange="setEstadoCivil2()"
                            ...
                            <option value="">Selecione</option>
                            <option value="1" {{ old('comprador2.estado_civil') == 1 ? 'selected' : '' }}>Solteiro(a)
                            </option>
                ...
                <div class="row mt-3 dados-casamento2" style="display:none;">
                    <div class="col-6">
                        ...
                        <select name="comprador2[regime_bens]" class="custom-select form-control form-control-border">
                            <option value="">Selecione</option>
                            <option value="1" {{ old('comprador2.regime_bens') == 1 ? 'selected' : '' }}>Comunhão
                                parcial de bens</option>
                            <option value="2" {{ old('comprador2.regime_bens') == 2 ? 'selected' : '' }}>Comunhão
                                Universal de Bens</option>
                            <option value="3" {{ old('comprador2.regime_bens') == 3 ? 'selected' : '' }}>Separação de
                                bens</option>
                        </select>
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <input type="date" value="{{ old('comprador2.data_casamento') }}"
                            name="comprador2[data_casamento]" placeholder="" class="form-control form-control-border">
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-3">
                        ...
                        <input type="text" value="{{ old('endereco_comprador2.cep') }}" onkeyup="pesquisacep(1)"
                            name="endereco_comprador2[cep]" id="cep1" placeholder=""
                            class="form-control form-control-border">
                    </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-4">
                        ...
                        <select name="vendedor[estado_civil]" class="custom-select form-control form-control-border">
                            <option value="1" @if ($vendedor->estado_civil == 1) selected
                                @endif>Solteiro(a)</option>
                            <option value="2" @if ($vendedor->estado_civil == 2) selected
                                @endif>Casado(a)</option>
                            <option value="3" @if ($vendedor->estado_civil == 3) selected @endif>União
                                estável</option>
                            <option value="4" @if ($vendedor->estado_civil == 4) selected
                                @endif>Divorciado(a)</option>
                            <option value="5" @if ($vendedor->estado_civil == 5) selected
