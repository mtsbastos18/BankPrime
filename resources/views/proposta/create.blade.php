                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('salvar-proposta') }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-3">
                                            ...
                                            <input type="text" onkeyup="pesquisacep(1)" name="endereco_comprador[cep]"
                                                id="cep1" placeholder="" class="form-control form-control-border">
                                        </div>

                                        <div class="col-5">
                                            <label>Endereço residencial</label>
                                            <input type="text" name="endereco_comprador[logradouro]" id="rua1"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="endereco_comprador[telefone]" id="telefone"
                            ...
                            <div class="card card-navy conjuge1" style="display:none;">
                                ...
                                <div class="card-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                            <input type="date" name="conjuge[data_nascimento]"
                            ...
                            <div class="row justify-content-end mb-2">
                                <div class="col-12 col-md-3 pull-right">
                                    <input type="button" class="btn btn-block btn-outline-primary"
                                        onclick="addComprador2()" value="Adicionar Comprador">
                                </div>
                            </div>
                            ...
                            <div class="card card-navy comprador2" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                            <input type="date" name="comprador2[nascimento]"
                                                placeholder="Data de Nascimento" class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label>Estado Civil</label>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-5">
                                            <label>Endereço residencial</label>
                                            <input type="text" name="endereco_comprador2[logradouro]" id="rua1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>

                                        <div class="col-2">
                                            <label>Número</label>
                                            <input type="text" name="endereco_comprador2[numero]" id="numero1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>
                                        <div class="col-2">
                                            <label>Complemento</label>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Bairro</label>
                                            <input type="text" name="endereco_comprador2[bairro]" id="bairro1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>

                                        <div class="col-4">
                                            <label>Cidade</label>
                                            <input type="text" name="endereco_comprador2[cidade]" id="cidade1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Telefone</label>
                                            <input type="text" name="endereco_comprador2[telefone]" id="telefone"
                                                placeholder="" class="form-control form-control-border telefone">
                                        </div>
                            ...
                            <div class="card card-navy conjuge2" style="display:none;">
                                ...
                                <div class="card-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                            <input type="date" name="conjuge2[data_nascimento]"
                                                placeholder="Data de Nascimento" class="form-control form-control-border">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                            ...
                            <div class="row justify-content-end mb-2 btn-comprador3" style="display:none;">
                                <div class="col-12 col-md-3 pull-right">
                                    <input type="button" class="btn btn-block btn-outline-primary"
                                        onclick="addComprador3()" value="Adicionar Comprador">
                                </div>
                            </div>
                            ...
                            <div class="card card-navy comprador3" style="display:none;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                            <input type="date" name="comprador3[nascimento]"
                                                placeholder="Data de Nascimento" class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label>Estado Civil</label>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Órgão expedidor</label>
                                            <input type="text" name="comprador3[orgao_emissor]"
                                                placeholder="Órgão expedidor" class="form-control form-control-border">
                                        </div>
                                        <div class="col-4">
                                            <label>UF emissão</label>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-5">
                                            <label>Endereço residencial</label>
                                            <input type="text" name="endereco_comprador3[logradouro]" id="rua1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>

                                        <div class="col-2">
                                            <label>Número</label>
                                            <input type="text" name="endereco_comprador3[numero]" id="numero1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>
                                        <div class="col-2">
                                            <label>Complemento</label>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Bairro</label>
                                            <input type="text" name="endereco_comprador3[bairro]" id="bairro1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>

                                        <div class="col-4">
                                            <label>Cidade</label>
                                            <input type="text" name="endereco_comprador3[cidade]" id="cidade1"
                                                placeholder="" class="form-control form-control-border">
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            <label>Telefone</label>
                                            <input type="text" name="endereco_comprador3[telefone]" id="telefone"
                                                placeholder="" class="form-control form-control-border telefone">
                                        </div>
                            ...
                            <div class="card card-navy comprador3" style="display:none;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-4">
                                            <label>Origem</label>
                                            <input type="text" name="profissao_comprador3[origem_renda]"
                                                placeholder="Origem" class="form-control form-control-border">
                                        </div>
                                    </div>
                            ...
                            <div class="card card-navy conjuge3" style="display:none;">
                                ...
                                <div class="card-body">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-4">
                                            <label>Data de Nascimento</label>
                                            <input type="date" name="conjuge3[data_nascimento]"
                                                placeholder="Data de Nascimento" class="form-control form-control-border">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="number" name="imovel[vagas]" placeholder="Quantidade de vagas"
                                                min="0" class="form-control form-control-border">
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="imovel[contato_avaliacao]"
                                                placeholder="Contato de avaliação"
                                                class="form-control form-control-border">
                                        </div>
