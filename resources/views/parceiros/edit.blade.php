                            ...
                            <form method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row mt-2" id="target-tipo-parceiro">
                                    ...
                                    @else
                                        <div class="col-6">
                                            <label>CNPJ</label>
                                            <input type="text" name="cnpj" value="{{ $parceiro->cnpj }}"
                                                placeholder="CNPJ" class="form-control form-control-border cnpj" required>
                                        </div>
                                        <div class="col-6">
                                            <label>Apelido (Exibido no sistema)</label>
                                            <input type="text" name="apelido" value="{{ $parceiro->apelido }}"
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="email" placeholder="E-mail"
                                            value="{{ $parceiro->email }}" class="form-control form-control-border"
                                            required>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="banco" placeholder="Banco"
                                            value="{{ $parceiro->banco }}" class="form-control form-control-border">
                                    </div>
                                    <div class="col-6">
                                        <label>Agência</label>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="conta" placeholder="Conta"
                                            value="{{ $parceiro->conta }}" class="form-control form-control-border"
                                            required>
                                    </div>
                                </div>
